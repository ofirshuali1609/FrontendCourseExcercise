...
export class FlightsService {
  ...
  private flights = [
    new Flight('W61283','Tel Aviv','Krakow',new Date('2025-01-02'),
    '10:30',new Date('2025-02-10'),'14:00',180, 'https://www.gotravel.co.il/userfiles/_big_5697A25AD12034304C7A02DE637217A8.png'),
    new Flight('LX8396','Larnaca','Zurich',new Date('2025-02-04'),
    '12:45',new Date('2025-02-15'),'17:00',150,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRT2BzoMCWETyqHPHEhqC3tbszeXIKKESzuLA&s'),
    ...
    new Flight('CA303','Moscow','Tokyo',new Date('2025-05-10'),
     '22:00',new Date('2025-05-11'),'13:00',
